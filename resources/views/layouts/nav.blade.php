    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Salary">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponentsSalary" data-parent="#exampleAccordion">
                    <i class="fa fa-fw fa-wrench"></i>
                    <span class="nav-link-text">Salary</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseComponentsSalary">
                    <li>
                        <a href="{{ url('admin/companies') }}">Company</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/employees') }}">Employee</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/slip/items') }}">Slip Items</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/slips') }}">Slip</a>
                    </li>
                </ul>
            </li>
